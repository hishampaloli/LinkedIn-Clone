        ...
        <div className="home flex justify-around">
          <div className="row1">
            ...
            <div className="middlemain ">
              ...
              {!articles ? (
                <Box
                  sx={{ display: "flex", marginTop: "50px", marginLeft: "50%" }}
                >
                  <CircularProgress />
                </Box>
              ) : (
                  ...
                  {articles.map((i) => {
                    return (
                      <div
                        className={
                          fade === i.id
                            ? "middlePosts flex flex-col items-start rounded-lg fade"
                            : "middlePosts flex flex-col items-start rounded-lg"
                        }
                      >
                        <div className="post-top flex flex-row justify-between">
                          <div className="pt-left">
                            <img src={i.actor.image} alt="" />
                          </div>
