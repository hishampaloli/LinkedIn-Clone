    ...
    <div className='header p-5 flex align-middle justify-between flex-row '>
        ...
        <div className="H-right">
            <ul className='flex justify-between '>
                ...
                <li className={st === 'me' ? 'flex flex-col icons st items-center' : 'flex flex-col icons items-center'} onClick={() => setSt('me')}> <img style={{borderRadius:'50%', width: '30px', hight:'30px'}} src={user.photoURL ? user.photoURL : 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRhGDy7e81HWRTCOnuK5H8X-5YmiQqslGdanA&usqp=CAU'} alt="" /> <p>Me</p></li>
